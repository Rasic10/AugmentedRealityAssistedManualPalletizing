...
public class MyRandomTrackableEventHandler : DefaultTrackableEventHandler
{
    ...
    void Update()
    {
        //if (finishedScanning && finished && hasMore) {
    ...
    protected void CreateTarget(int num, Vector3 scale, Vector3 position) {
        ...
        GameObject groundPlane = GameObject.Find("Ground Plane Stage Random");
